...
- Begin **Feature 03 - Database Schema** (Prisma + Neon Postgres data layer) when instructed. Awaiting user go-ahead before starting.
...
- `[ ]` Nothing in progress. Feature 02 is merged; Feature 03 not yet started (awaiting user go-ahead).
