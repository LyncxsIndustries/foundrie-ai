...
- Current Feature 62 transitive overrides (Context7-backed): `sharp@0.35.3` (exact; `allowScripts["sharp@0.35.3"]=true` must stay version-aligned) and `@opentelemetry/core@>=2.8.0` (floor under Trigger.dev’s OTel tree). See `docs/SECURITY_SCRIPT_OVERRIDES.md` and `research/NPM_SECURITY_OVERRIDE_AUDIT.md`.
