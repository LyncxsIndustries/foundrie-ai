...
- Project sharing: Owner invites Collaborators by email; Collaborators can edit canvas, use AI, and download ZIP.
- 2-role authorization model (Owner and Collaborator) enforced at the application layer.
