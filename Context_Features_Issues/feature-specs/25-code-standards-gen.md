...
- Generated standards must forbid premature team RBAC, custom admin portals, RLS, ABAC, audit logging, or hardware-key admin unless the requirements explicitly need them.
