...
Capture React Flow diagrams as PNG for ZIP inclusion.
...
- Use html-to-image or Konva for PNG capture.
- Capture only the diagram surface, not UI panels.
- Ensure capture bounds include all relevant nodes and edges.
- Handle fonts and dark background correctly.
